...
public class SignupRequest {
	...
	// 1. 실제 검증: 필수값, 1자 이상 ~ 50자 이하
	// 2. 문서 가이드: 필수값, 1자 이상, 50자 이하임을 명시
    @NotBlank(message = "사용자 이름은 필수입니다.")
    @Size(min = 1, max = 50, message = "사용자 이름은 최대 50자까지 가능합니다.")
    @Schema(description = "사용자 이름", example = "tester", minLength = 1, maxLength = 50, required = true)
    private String name;
